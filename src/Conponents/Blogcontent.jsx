        ...
        <div className="max-w-[1240px] mx-auto">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 p-4 sm:pt-1 md:mt-0 ss:pt-10 text-black ">
                <div className="col-span-2 px-1 gap-8 min-h-[100vh]">
                 ...
                 <div className="bg-white hidden sm:grid w-full round-lg drop-shadow-md py-2 max-h-[300px] overflow-hidden">
                    <h1 className='font-bold font-sans  text-center uppercase italic pb-3 '>Writer</h1>
                    <div>
                        <img className='w-40 h-40 rounded-full mx-auto object-cover' src={Logo}  />
                        <h2 className='font-bold  text-center text-gray-500 pt-1'>Bismark Arthur</h2>
                        <p className='font-medium  text-center text-gray-300 pt-1'>Softaware Developer/Digital Marketer</p>
                    </div>                    
                </div>                              
            </div>
        </div>
